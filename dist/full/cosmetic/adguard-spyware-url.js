...
const RULESET_ID = "adguard-spyware-url";
const SELECTORS = [".hello_from_adguard_tracking_params"];
const SELECTOR_LISTS = ["0"];
const HOSTNAMES = ["adguard.app","adguard.com","adguard.info"];
const SELECTOR_LIST_REFS = [0,0,0];
