...
const OPS = [
  {"f":"^[A-Za-z][A-Za-z0-9+.-]*://(?:[^/?#]*\\.)?starlight\\.digital/get\\-playlist\\-ad/hls\\-vod/files/.*\\.mp4/.*_adblock.*(?:[^A-Za-z0-9_.%\\-]|$)placement_id=","p":["placement_id"]},
  {"f":"^[A-Za-z][A-Za-z0-9+.-]*://(?:[^/?#]*\\.)?starlight\\.digital/get\\-playlist\\-ad/hls\\-vod/files/.*\\.mp4/.*_adblock.*(?:[^A-Za-z0-9_.%\\-]|$)site_id=","p":["site_id"]},
  {"f":"^[A-Za-z][A-Za-z0-9+.-]*://(?:[^/?#]*\\.)?vcms\\-api.*\\.starlight\\.digital/hls/.*\\?file=.*\\&testadv=","p":["testadv"]}
];
