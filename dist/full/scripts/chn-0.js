...
const OPS = [
  {"f":"^[A-Za-z][A-Za-z0-9+.-]*://(?:[^/?#]*\\.)?mesh\\.if\\.iqiyi\\.com/portal/.*/recommend\\?.*(?:[^A-Za-z0-9_.%\\-]|$)ad=","p":["ad"]},
  {"f":"^[A-Za-z][A-Za-z0-9+.-]*://(?:[^/?#]*\\.)?mesh\\.if\\.iqiyi\\.com/portal/.*/recommend\\?.*(?:[^A-Za-z0-9_.%\\-]|$)adExt=","p":["adExt"]},
  {"f":"^[A-Za-z][A-Za-z0-9+.-]*://(?:[^/?#]*\\.)?mesh\\.if\\.iqiyi\\.com/portal/lw/search/.*(?:[^A-Za-z0-9_.%\\-]|$)ad=","p":["ad"]},
  {"f":"^[A-Za-z][A-Za-z0-9+.-]*://(?:[^/?#]*\\.)?mesh\\.if\\.iqiyi\\.com/portal/lw/search/.*(?:[^A-Za-z0-9_.%\\-]|$)adExt=","p":["adExt"]}
];
